            ...
            return (
                <div className="min-h-screen bg-[#fbf9f1] flex items-center justify-center p-6">
                    <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center border border-red-100">
                        ...
                        <h1 className="text-2xl font-black text-gray-900 mb-2">Oops, something broke.</h1>
                        <p className="text-gray-500 mb-6 font-medium text-sm">We've encountered an unexpected error. Don't worry, just refresh the page to get back on track.</p>
                        <button
