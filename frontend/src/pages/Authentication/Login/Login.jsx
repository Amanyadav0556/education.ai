...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative py-12"
            ...
            {/* Main Card */}
            <div className="w-full max-w-[420px] bg-white/80 backdrop-blur-2xl rounded-[32px] p-10 relative z-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-white/50">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            type="email"
                            className="w-full bg-gray-50/50 border border-gray-100 text-gray-900 text-[15px] rounded-2xl focus:ring-2 focus:ring-gray-200 focus:border-gray-200 block pl-11 pr-4 py-3.5 transition-all outline-none placeholder:text-gray-400"
                            placeholder="Email"
                            required
                            value={email}
                    ...
                    <div className="relative">
                        ...
                        <input
                            type="password"
                            className="w-full bg-gray-50/50 border border-gray-100 text-gray-900 text-[15px] rounded-2xl focus:ring-2 focus:ring-gray-200 focus:border-gray-200 block pl-11 pr-11 py-3.5 transition-all outline-none placeholder:text-gray-400"
                    ...
                    <div className="flex justify-end pt-1">
                        <a href="#" className="text-[13px] text-gray-600 hover:text-gray-900 font-medium transition-colors">
                            Forgot password?
                        </a>
                    </div>
                    ...
                    <p className="text-center text-sm text-gray-400 mt-4">
                        <Link to="/signup" className="text-gray-600 hover:text-gray-900">Need an account? Sign up</Link>
                    </p>
                </form>
