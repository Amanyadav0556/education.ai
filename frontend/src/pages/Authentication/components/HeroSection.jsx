...
export default function HeroSection() {
 ...
 className="text-text-muted leading-relaxed mb-12 max-w-sm"
 >
 ...
 >
 <div className={`w-12 h-12 rounded-2xl bg-bg-surface/5 border border-white/10 flex items-center justify-center ${feature.color}`}>
 <Icon size={24} />
 </div>
 ...
 <span className="text-sm text-text-muted font-medium">Trusted by top students</span>
 </div>
 </motion.div>
 </div>
 );
