...
export default function LoginForm({ setAuthMode }) {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <h2 className="text-[32px] font-black text-gray-900 tracking-tight mb-2">Welcome back</h2>
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-50 border border-gray-200 focus:border-[#4f46e5] focus:ring-4 focus:ring-[#4f46e5]/10 text-gray-900 rounded-xl py-3.5 pl-11 pr-4 outline-none placeholder:text-gray-400 font-semibold text-sm transition-all shadow-sm"
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-50 border border-gray-200 focus:border-[#4f46e5] focus:ring-4 focus:ring-[#4f46e5]/10 text-gray-900 rounded-xl py-3.5 pl-11 pr-11 outline-none placeholder:text-gray-400 font-semibold text-sm transition-all shadow-sm"
                ...
                <div className="pt-2 pb-5 flex justify-between items-center">
                    <label className="flex items-center space-x-3 cursor-pointer group">
                        <div className="relative flex items-center justify-center">
                            <input type="checkbox" className="peer appearance-none w-5 h-5 border border-gray-300 rounded-md bg-gray-50 checked:bg-[#4f46e5] checked:border-[#4f46e5] transition-all cursor-pointer shadow-sm" />
