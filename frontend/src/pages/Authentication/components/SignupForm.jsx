...
import { EyeOff, Eye, Loader2, User, Mail, Lock } from 'lucide-react';
...
export default function SignupForm({ setAuthMode }) {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <h2 className="text-[32px] font-black text-gray-900 tracking-tight mb-2">Create account</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border border-gray-200 focus:border-[#4f46e5] focus:ring-4 focus:ring-[#4f46e5]/10 text-gray-900 rounded-xl py-3 pl-11 pr-4 outline-none placeholder:text-gray-400 font-semibold text-sm transition-all shadow-sm"
                    ...
                    <div className="space-y-1.5">
                        <label className="text-sm font-bold text-gray-900 ml-1">Target Exam</label>
                        <select
                            value={formData.targetExam}
                            onChange={(e) => setFormData({ ...formData, targetExam: e.target.value })}
                            className="w-full bg-gray-50 border border-gray-200 focus:border-[#4f46e5] focus:ring-4 focus:ring-[#4f46e5]/10 text-gray-900 rounded-xl py-3 px-4 outline-none font-semibold text-sm transition-all shadow-sm appearance-none"
                        >
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-50 border border-gray-200 focus:border-[#4f46e5] focus:ring-4 focus:ring-[#4f46e5]/10 text-gray-900 rounded-xl py-3 pl-11 pr-11 outline-none placeholder:text-gray-400 font-semibold text-sm transition-all shadow-sm"
                ...
                <div className="pt-2 pb-5">
                    <label className="flex items-center space-x-3 cursor-pointer group">
                        <div className="relative flex items-center justify-center">
                            <input type="checkbox" required className="peer appearance-none w-5 h-5 border border-gray-300 rounded-md bg-gray-50 checked:bg-[#4f46e5] checked:border-[#4f46e5] transition-all cursor-pointer shadow-sm" />
            ...
            <div className="grid grid-cols-2 gap-4">
                <button type="button" className="flex items-center justify-center space-x-2 bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 text-gray-700 shadow-sm rounded-xl py-3 transition-all font-bold text-[13px] active:scale-[0.98]">
