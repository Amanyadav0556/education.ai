                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-8 min-w-0">
                        ...
                        <div className="bg-bg-surface p-7 rounded-[28px] border border-border-base shadow-sm relative">
                            ...
                            <Link to="/exam-info" className="flex items-center justify-center w-full bg-bg-surface-hover hover:bg-bg-surface-hover border border-border-strong text-text-sub font-bold py-3 rounded-xl text-xs transition-colors active:scale-[0.98]">View Details</Link>
                        </div>
