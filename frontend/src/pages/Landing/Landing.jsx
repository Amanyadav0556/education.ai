      ...
      <div className="max-w-7xl mx-auto px-6 h-full flex flex-col relative z-10">
        ...
        <nav className="flex justify-between items-center py-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-xl tracking-tight text-gray-900">AceCoach</span>
          </div>

          <div className="hidden md:flex items-center space-x-8 font-semibold text-[15px] text-gray-900">
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <>
                <Link to="/dashboard" className="font-semibold text-gray-900 hover:text-[#836bb4] transition-colors">Dashboard</Link>
        ...
        <div className="flex-1 flex flex-col lg:flex-row items-center pt-16 pb-24 gap-16">
          ...
          <div className="flex-1 lg:max-w-xl flex flex-col justify-center">
            <h1 className="text-6xl lg:text-7xl font-extrabold text-gray-900 tracking-[-0.04em] leading-[1.05] mb-6">
              Smart Score Growth
            </h1>
            <p className="text-lg text-gray-600 mb-10 leading-relaxed pr-8 font-medium">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="btn btn-outline px-8 py-4 text-[15px] flex items-center space-x-2 bg-[#f4f7e6] border-[#e1e6c3] text-gray-800 hover:bg-[#eaf0c1] hover:border-[#d6df9e]">
