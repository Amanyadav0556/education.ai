...
const QUICK_PROMPTS = [
    { label: '⚡ Explain Newton\'s Laws', msg: 'Explain Newton\'s Laws of Motion in simple terms with examples' },
    { label: '📐 Solve Integration', msg: 'How do I integrate sin(x)cos(x)dx step by step?' },
    { label: '🧪 Explain Atomic Structure', msg: 'Explain atomic structure and Bohr\'s model of the atom' },
    { label: '📖 Study Plan for Physics', msg: 'Create a 2-week study plan for Physics covering Mechanics and Thermodynamics' },
    { label: '🎯 Generate 5 Questions', msg: 'Generate 5 multiple choice questions on Calculus at medium difficulty' },
    { label: '📊 Analyze My Weak Areas', msg: 'Based on my progress, what should I focus on to improve my scores?' },
];
...
export default function AiView() {
    const { chatMessages, sendAiMessage, clearChat, aiLoading } = useApp();
        ...
        <div style={{ display: 'flex', gap: 24, height: 'calc(100vh - 140px)' }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        <div style={{ fontWeight: 700, fontSize: 15 }}>EduAI Personal Tutor</div>
                        <div style={{ fontSize: 12, color: '#6ee7b7' }}>● Online · Ready to help</div>
                    </div>
                    <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
                        <span className="badge badge-success">GPT-Powered</span>
